  ...
  render() {
    return (
      <View style={styles.container}>
        <Text style={styles.topText}>NAME : ANTO</Text>
        <Text style={styles.bottomText}>ID : 0002</Text>
        <Text style={styles.bottomText}>TIME : 18:00</Text>
        <Text style={styles.bottomText}>DATE : 03/01/2021</Text>
